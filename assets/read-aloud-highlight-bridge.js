(function () {
  ...
  function buildMap(content, source) {
    ...
    var sourceId = source.getAttribute("data-id") || "";
    if (/_p999$/.test(sourceId) || sourceId === "pg008_p007" || sourceId === "pg009_p005" || sourceId === "pg010_im001" || sourceId === "pg010_im002" || sourceId === "pg011_im001" || sourceId === "pg011_im002") return [];
