...
for (const [id, expected, filename] of [["pg065_p036", page65Abacus, "pg065_p036_adt_abacus_equals_clean.mp3"], ["pg065_p037", page65Exercise, "pg065_p037_adt_exercise_equals_clean.mp3"]]) {
