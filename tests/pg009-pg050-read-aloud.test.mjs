...
assert.match(texts.pg036_im003, /^Table description\. The chart has eight rows and nine columns\./, "question 1 must introduce its chart structure");
assert.equal(audios.pg036_im003, "pg036_im003_table_description.mp3", "question 1 must have table-description audio");
assert.ok(timecodes.pg036_im003, "question 1 table description must retain timing data");
assert.match(page36, /data-id="pg036_p002"[\s\S]*data-id="pg036_im003"[\s\S]*class="book-table"[\s\S]*aria-label="Number chart from 201 to 909"/, "the table description must play after the instruction and before the chart");
...
const page41Models = {
  pg041_p037: "Fifth place-value model. In the hundreds column, six green counters are added to two green counters. Equals. In the tens column, three blue counters are added to six blue counters. Equals. In the ones column, two red counters are added to seven red counters. Equals. Fill in the three column totals and the final sum.",
  pg041_p038: "Sixth place-value model. In the hundreds column, three green counters are added to three green counters. Equals. In the tens column, three blue counters are added to three blue counters. Equals. In the ones column, three red counters are added to three red counters. Equals. Fill in the three column totals and the final sum."
};
...
assert.ok(page41.indexOf('data-id="pg041_p037"') < page41.indexOf('data-id="pg041_p018"'), "the fifth model description must precede question 6");
...
assert.deepEqual(
  ...
  ["pg051_p001", "pg051_p060", "pg051_p061"],
  "page 51 must narrate its heading, instruction, and one reliable Solution passage"
);
...
const page65Abacus = "Or. 247 minus 123 equals. The abacus has columns for hundreds, tens and ones. Crossed beads show the amount subtracted. 1 bead remains in the hundreds column, 2 beads remain in the tens column, and 4 beads remain in the ones column. Therefore, 247 minus 123 equals 124.";
const page65Exercise = "Exercise 1. Write the answer in each question. Question 1. 299 minus 133 equals. Question 2. 795 minus 275 equals. Question 3. 444 minus 200 equals. Question 4. 568 minus 346 equals. Question 5. 306 minus 204 equals. Question 6. 597 minus 50 equals. Question 7. 980 minus 440 equals. Question 8. 600 minus 300 equals. Question 9. 649 minus 48 equals. Question 10. 937 minus 415 equals. Question 11. 935 minus 213 equals. Question 12. 528 minus 417 equals. Question 13. 438 minus 216 equals. Question 14. 287 minus 240 equals. Question 15. 386 minus 215 equals. Question 16. 756 minus 524 equals. Question 17. 368 minus 118 equals. Question 18. 999 minus 439 equals.";
for (const [id, expected, filename] of [["pg065_p036", page65Abacus, "pg065_p036_adt_abacus_equals_clean.mp3"], ["pg065_p037", page65Exercise, "pg065_p037_adt_exercise_equals_clean_trimmed.mp3"]]) {
...
const page66Exercise = "Exercise 2. Write the answer in each question. Question 1. 436 minus 321 equals. Question 2. 758 minus 643 equals. Question 3. 239 minus 115 equals. Question 4. 384 minus 243 equals. Question 5. 895 minus 670 equals. Question 6. 267 minus 145 equals. Question 7. 530 minus 410 equals. Question 8. 682 minus 381 equals. Question 9. 999 minus 717 equals. Question 10. 246 minus 123 equals. Question 11. 896 minus 643 equals. Question 12. 900 minus 500 equals. Question 13. 729 minus 408 equals. Question 14. 256 minus 113 equals. Question 15. 446 minus 325 equals. Question 16. 185 minus 172 equals. Question 17. 388 minus 216 equals. Question 18. 888 minus 283 equals.";
...
for (const [id, expected, filename] of [["pg066_p031", page66Exercise, "pg066_p031_adt_exercise_equals_clean.mp3"], ["pg066_p032", page66Activity, "pg066_p032_adt_activity.mp3"]]) {
...
assert.equal(texts.pg112_p001, "The picture shows three schoolchildren standing in a line and holding hands. I have to leave the line. Goodbye. Look, now I am far from you. The following picture shows I am far from you. The following picture shows one pupil standing apart while the other two schoolchildren stand together holding hands. I am one third of the three of us. What about you? We are two-thirds of the three of us.", "page 112 must describe each image and then read its printed words exactly without invented speaker labels");
