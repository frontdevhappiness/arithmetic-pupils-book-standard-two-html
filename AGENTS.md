# Arithmetic Pupil’s Book Standard Two — ADT Bundle Reference
...
**Arithmetic Pupil’s Book Standard Two** — This is a Standard Two arithmetic pupil’s book from Tanzania, published by the Tanzania Institute of Education and written in English for early primary learners, roughly ages 7–8. It introduces foundational mathematics through numbers to 999, place value, addition, subtraction, multiplication, division, simple fractions, measurement and shapes. The book uses a practical, activity-based approach with songs, games, pictures, word problems and everyday examples, emphasising basic skills, step-by-step understanding and classroom participation.
...
├── ARITHMETIC-PUPILS-STD-2.db                    # SQLite database (pipeline state)
├── ARITHMETIC-PUPILS-STD-2.pdf                   # Original source PDF
...
{
  "pg001_gp001_tx001": "",
  "pg001_im001": "Certificate text: The United Republic of Tanzania. Ministry of Education, Science and Technology. Certificate of Approval, number 1646. Title of Publication: Arithmetic Pupil’s Book Standard Two. Publisher: Tanzania Institute of Education. Author: Tanzania Institute of Education. ISBN: 978-9912-753-59-4. This book was approved by the Ministry of Education, Science and Technology on 11th September 2024 as a textbook for Standard Two in Primary Schools in Tanzania, as per the 2023 syllabus. Signed by Dr Lyabwene M. Mtahabwa, Commissioner for Education."
}
```
...
```json
{
  "title": "Arithmetic Pupil’s Book Standard Two",
  "bundleVersion": "60b7b44a22f1d838",
  "languages": {
    "available": [
      "en-GB"
    ],
...
| Original PDF | `ARITHMETIC-PUPILS-STD-2.pdf` |
| Pipeline database | `ARITHMETIC-PUPILS-STD-2.db` (SQLite) |
